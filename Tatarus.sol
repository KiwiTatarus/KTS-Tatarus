...
contract ProxyStorage {
     ...
     ** length     input                                                         usage
     *******************************************************************************************************
     ** 19         "USDT.proxy.owner"                                         Proxy Owner
     ** 27         "USDT.pending.proxy.owner"                                 Pending Proxy Owner
     ** 28         "USDT.proxy.implementation"                                Proxy Implementation
 ...
 */
contract Tatarus is TrueCurrency {
